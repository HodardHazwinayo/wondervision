...
$action=$_GET['action'];
if($action=="delete"){
echo $sql_del="DELETE FROM enquiry_accomodation_mapping WHERE enquiry_id='$eid' and accomodation_type_id='$aid'";
...
if(isset($_REQUEST['enquiry']))
{
	...
	$deptdate=date("Y-m-d", strtotime($_REQUEST['departure_date']));
	 ...
	 $sql15 = "UPDATE enquiry_accomodation_mapping SET checkindate='$arrdate',checkoutdate='$deptdate',noofadults='".$_REQUEST['adult_count']."',noofchildren='".$_REQUEST['child_count']."',noofrooms='".$_REQUEST['no_room']."',amount='".$_REQUEST['net_amount']."',commission='".$_REQUEST['com']."',discount='".$_REQUEST['dsc']."',roomtype='".$_REQUEST['r_type']."',servicetax='".$_REQUEST['st']."'/*,vat='".$_REQUEST['vat']."'*/ WHERE enquiry_id='$eid' and accomodation_type_id='$aid'";
...
document.getElementById("adult_count").selectedIndex = <?php echo $adl-1 ?>;
document.getElementById("child_count").selectedIndex = <?php echo $chl-- ?>;
document.getElementById("no_room").selectedIndex = <?php echo $rum-- ?>;
	...
	<div class="main" id="main">
		...
		<div class="content" id="main-content">
			...
			<div class="row-fluid" id="main-content-row">
				...
				<h2 style="width:195%;">Hotel Booking form</h2>
					...
					<div class="enquiryfrom">
						...
						<table>
							<tr>
								...
								<td>
									<input type="text" size="30px"name="h_name" id="h_name" value='<?php echo $hn ?>' readonly>
								...
								<select name="r_type"  id="r_type"style="width:220px; height:25px; ">
							...
							<tr>
								<td><h4>Room</h4></td>
								<td>
								<select name="no_room"  id="no_room" style="width:220px; height:25px; ">
										<option value="0">0</option>
										<option value="1">1</option>
										<option value="2">2</option>
										<option value="3">3</option>
