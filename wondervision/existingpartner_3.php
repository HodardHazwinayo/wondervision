...
header("Location:booking_2_3.php");
			...
			<div class="row-fluid" id="main-content-row">
				...
				<h2 style="width:195%;">Enquiry form</h2>
					...
					<div class="enquiryfrom">
						...
						<table>
							<tr>
								<td><h4>Enquiry ID</h4></td>
								<td>
									<input type="text" size="30px" name="customer_id" value="WVE5693">
								...
								<td><h4>Mobile</h4></td>
								<td>
									<input type="text" size="30px" name="mobile" value="9051404842">
								</td>
							...
							<tr>
								<td><h4>Name</h4></td>
								<td>
									<input type="text" size="30px" name="name" value="Prasenjit Kumar">
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><h4>Email</h4></td>
								<td>
									<input type="text" size="30px" name="email" value="prasenjit.mca@gmail.com">
								</td>
							...
							<tr>
								...
								<td>
								<input type="text" size="30px" name="addr1" value="Baidyabati">
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><h4>Address Line 2</h4></td>
								<td>
								<input type="text" size="30px" name="add2" value="">
								</td>
							</tr>
							<tr>
								<td><h4>City</h4></td>
								<td>
								<input type="text" size="30px" name="city" value="Hooghly">
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><h4>Pin</h4></td>
								<td>
								<input type="text" size="30px" name="pin" value="712222">
								</td>
							</tr>
							<tr>
