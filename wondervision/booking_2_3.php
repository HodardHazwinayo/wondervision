...
<head>
	...
	<script>
		...
		{
			document.getElementById("demo1").innerHTML="18000";
			document.getElementById("demo2").innerHTML="1200";
			document.getElementById("demo3").innerHTML="19200";
		  ...
		  <div style="float:left;width:1050px;height:auto;margin:20px 20px 20px 30px;">
			<div id="tabs" style="float:left;width:430px;height:280px;">
				<ul>
				  ...
				  <div id="tabs-1">
					  <input type="text" value="Coco Palm Beach" size="30"><br>
					  <input type="text" value="Puri" size="30">
					  <input type="text" value="Puri" size="30">
					  <input type="text" value="Address Line 3" size="30">
					  <input type="text" value="65456321" size="30">
			...
			<div style="float:left;margin:10px;"></div>
			  <div style="float:left;width:1034px;height:260px;border:2px solid #AAAAAA;border-radius:5px;">
					...
					<tr>
						<td>Customer ID</td><td><input type="text" value="WVC2356" ></td>
						<td>&nbsp;</td>
						<td>Name</td><td><input type="text" value="Prasenjit Kumar" ></td>
						<td>&nbsp;</td>
						<td>Phone Number</td><td><input type="text" value="9051404842" ></td>
					...
					<table align="center">
						<tr>
							...
							<td align="center"><input type="text" value="Baidyabati"></td>
						...
						<tr>
							...
							<td align="center"><input type="text" value="Hooghly"></td>
							<td align="center">Pin</td>
							<td align="center"><input type="text" value="712222"></td>
						</tr>
					...
					<td>
						<input type="text" name="rate" value="6000">
					</td>
						<td>/- INR</td>
						<td>&nbsp;&nbsp;</td>
						<td>&nbsp;&nbsp;</td>
						...
						<td>&nbsp;&nbsp;</td>
						<td>&nbsp;&nbsp;</td>
						<td><td align="right;"><input type="image" src="images/round_arrow_right.png" alt="Submit" style="float:right;padding-right:30px;" onclick="myFunction1()"></td></td>
					</tr>
					</table>
					</div>
			  ...
			  <div style="float:left;width:1034px;height:330px;">
				   ...
				   <form method="post" action="">
				   	<table align="center" style="margin-top:10px;">
				   		<tr><td>Total Amount</td><td><div id="demo1" style="width:235px;height:25px;border:1px solid #aaaaaa; border-radius:3px;"></div></td></tr>
				   		<tr><td>S.C./L.T./C.C.</td><td><div id="demo2" style="width:235px;height:25px;border:1px solid #aaaaaa; border-radius:3px;"></div></td></tr>
				   		<tr><td>Gross total</td><td><div id="demo3" style="width:235px;height:25px;border:1px solid #aaaaaa; border-radius:3px;"></div></td></tr>
				   		<tr><td>Advance</td><td><input type="text" name="advance" style="width:228px;height:18px;border:1px solid #aaaaaa; border-radius:3px;"></td></tr>
						<tr><td>Due</td><td><input type="text" name="due" style="width:228px;height:18px;border:1px solid #aaaaaa; border-radius:3px;"></td></tr>
