		  ...
		  <div style="float:left;width:1050px;height:auto;margin:20px 20px 20px 30px;">
				...
				<ul>
				  ...
				  <div id="tabs-1">
					  ...
					  <input type="text" value="Coco Palm Beach" size="30"><br>
						Address Line 1<br>
					  <input type="text" value="Puri" size="30"><br>
					  Address Line 2<br>
					  <input type="text" value="Puri Marine Drive" size="30"><br>
						Phone Number<br>
				  ...
				  <div id="tabs-2">
					  Hotel name<br>
					  <input type="text" value="" size="30"><br>
						Address Line 1<br>
					  <input type="text" value="" size="30"><br>
					  Address Line 2<br>
					  <input type="text" value="" size="30"><br>
			...
			<div style="float:left;margin:10px;"></div>
			  ...
			  <div style="float:left;width:1034px;height:330px;">
				   <div style="float:left;border:2px solid #AAAAAA;height:103%;width:49%;border-radius:5px;">
				   ...
				   <div style="float:right;border:2px solid #AAAAAA;height:103%;width:50%;border-radius:5px;">
				   <h2>Payments</h2>
				   <form method="post" action="">
				   	<table align="center" style="margin-top:10px;">
				   		<tr><td>Total Amount</td><td><input type="text" name="tot_amount" value="16800" style="width:233px;border-radius:3px;"></td></tr>
				   		<tr><td>S.C./L.T./C.C.</td><td><input type="text" name="tax" value="2300" style="width:233px;border-radius:3px;"></td></tr>
				   		<tr><td>Gross total</td><td><input type="text" name="gross_total" value="19100" style="width:233px;border-radius:3px;"></td></tr>
				   		<tr><td>Advance</td><td><input type="text" name="advance" value="5000" style="width:233px;border-radius:3px;"></td></tr>
				   		
						<tr><td>Due</td><td><input type="text" name="due" value="14100" style="width:233px;border-radius:3px;"></td></tr>
