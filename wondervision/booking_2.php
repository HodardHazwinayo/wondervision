		  ...
		  <div style="float:left;width:1050px;height:auto;margin:20px 20px 20px 30px;">
			...
			<div style="float:left;margin:10px;"></div>
			  <div style="float:left;width:1034px;height:260px;border:2px solid #AAAAAA;border-radius:5px;">
					...
					<tr>
						<td>Customer ID</td><td><input type="text" value="WVC2358" ></td>
						<td>&nbsp;</td>
						<td>Name</td><td><input type="text" value="Abhirup Ghosh" ></td>
						<td>&nbsp;</td>
						<td>Phone Number</td><td><input type="text" value="9434538735" ></td>
					...
					<table align="center">
						<tr>
							...
							<td align="center"><input type="text" value="Sealdah"></td>
							<td align="center">Address Line 2</td>
							<td align="center"><input type="text" value="Moulali"></td>
						</tr>
						
						<tr>
							<td align="center">City</td>
							<td align="center"><input type="text" value="Kolkata"></td>
							<td align="center">Pin</td>
							<td align="center"><input type="text" value="700008"></td>
						</tr>
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>MAP</td><td><input type="checkbox" checked></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<td>
						<input type="text" name="rate" value="5600">
					</td>
						<td>/- INR</td>
						<td>&nbsp;&nbsp;</td>
						<td>&nbsp;&nbsp;</td>
