...
<script>
	...
	window.location = 'booking_2_4.php';
	...
	<div class="main" id="main">
		...
		<h2 style="width:195%;">Money Reciept</h2>
			...
			<form method="post">
				<table border="0">
					<tr>
						<td><h4>Cash reciept #</h4></td><td colspan="3">1385416985</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td><h4>Date</h4></td><td colspan="3"><?php echo date('Y-m-d'); ?></td>
					</tr>
					<tr>
						<td><h4>Recieved from</h4></td><td colspan="3">WVC2356</td>
					</tr>
					<tr>
					...
					<tr>
						<td><h4>Amount recieved</h4></td><td><input type="text" name="name" value="" style="width:230px;">&nbsp;/- INR</td>
					</tr>
					
					<tr>
						<td><h4>Total amount</h4></td><td><input type="text" name="name" value="<?php echo $_SESSION['advance']; ?>" style="width:230px;" readonly>&nbsp;/- INR</td>
					</tr>
					
					<tr>
						<td><h4>Mode of Payment</h4></td>
						<td><input type="radio" name="cheque">&nbsp;Cheque payment
							<input type="radio" name="creditcard" checked> &nbsp;Credit card
						<input type="radio" name="cashpayment"> &nbsp;Cash</td>
