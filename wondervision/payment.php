...
<script>
	...
	window.location = 'booking_2_2.php';
	...
	<div class="main" id="main">
		...
		<h2 style="width:195%;">Money Reciept</h2>
			...
			<form method="post">
				<table border="0">
					<tr>
						<td><h4>Cash reciept #</h4></td><td colspan="3">1385412365</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td><h4>Date</h4></td><td colspan="3"><?php echo date('Y-m-d'); ?></td>
					</tr>
					<tr>
						<td><h4>Recieved from</h4></td><td colspan="3">Abhirup Ghosh</td>
					</tr>
					<tr>
						<td><h4>Phone number</h4></td><td colspan="3">9434538735</td>
					</tr>
