...
--
-- Dumping data for table `accomodation_package_mapping`
--

LOCK TABLES `accomodation_package_mapping` WRITE;
/*!40000 ALTER TABLE `accomodation_package_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `accomodation_package_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `accomodation_type_details` WRITE;
/*!40000 ALTER TABLE `accomodation_type_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `accomodation_type_details` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `bed_type_master`
--

LOCK TABLES `bed_type_master` WRITE;
/*!40000 ALTER TABLE `bed_type_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `bed_type_master` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `country_master` VALUES ('India');
...
LOCK TABLES `enquiry_accomodation_mapping` WRITE;
/*!40000 ALTER TABLE `enquiry_accomodation_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `enquiry_accomodation_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `enquiry_comments_details` WRITE;
/*!40000 ALTER TABLE `enquiry_comments_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `enquiry_comments_details` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `enquiry_guest_mapping`
--

LOCK TABLES `enquiry_guest_mapping` WRITE;
/*!40000 ALTER TABLE `enquiry_guest_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `enquiry_guest_mapping` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `enquiry_package_maping`
--

LOCK TABLES `enquiry_package_maping` WRITE;
/*!40000 ALTER TABLE `enquiry_package_maping` DISABLE KEYS */;
/*!40000 ALTER TABLE `enquiry_package_maping` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `enquiry_partner_mapping`
--

LOCK TABLES `enquiry_partner_mapping` WRITE;
/*!40000 ALTER TABLE `enquiry_partner_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `enquiry_partner_mapping` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `enquiry_service_mapping`
--

LOCK TABLES `enquiry_service_mapping` WRITE;
/*!40000 ALTER TABLE `enquiry_service_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `enquiry_service_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `feature_transport_mapping`
--

LOCK TABLES `feature_transport_mapping` WRITE;
/*!40000 ALTER TABLE `feature_transport_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `feature_transport_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `guest_gift_avail_details`
--

LOCK TABLES `guest_gift_avail_details` WRITE;
/*!40000 ALTER TABLE `guest_gift_avail_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `guest_gift_avail_details` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `guest_gift_master`
--

LOCK TABLES `guest_gift_master` WRITE;
/*!40000 ALTER TABLE `guest_gift_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `guest_gift_master` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `guest_master` WRITE;
/*!40000 ALTER TABLE `guest_master` DISABLE KEYS */;
INSERT INTO `guest_master` VALUES (23,1,3,'Abhijit','Chowdhury','','null','','','Dankuni','','','West Bengal','Iceland','','2013-08-07 17:47:12',''),(25,1,3,'as','Chowdhury','avimcakolkata@gmail.com','null','','','Dankuni','','','Maharashtra','Bahrain','','2013-08-07 17:52:57','');
/*!40000 ALTER TABLE `guest_master` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `guest_membership_type_master`
--

LOCK TABLES `guest_membership_type_master` WRITE;
/*!40000 ALTER TABLE `guest_membership_type_master` DISABLE KEYS */;
INSERT INTO `guest_membership_type_master` VALUES (1,'silver','silver',1),(2,'gold','gold',2),(3,'General','General',3);
/*!40000 ALTER TABLE `guest_membership_type_master` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `guest_rewards`
--

LOCK TABLES `guest_rewards` WRITE;
/*!40000 ALTER TABLE `guest_rewards` DISABLE KEYS */;
/*!40000 ALTER TABLE `guest_rewards` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `guest_types` VALUES (1,'Normal','Normal'),(2,'Accumalated','Accumalated');
/*!40000 ALTER TABLE `guest_types` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `hotel_feature_mapping`
--

LOCK TABLES `hotel_feature_mapping` WRITE;
/*!40000 ALTER TABLE `hotel_feature_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `hotel_feature_mapping` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `hotel_group_master`
--

LOCK TABLES `hotel_group_master` WRITE;
/*!40000 ALTER TABLE `hotel_group_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `hotel_group_master` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `hotel_partner_mapping`
--

LOCK TABLES `hotel_partner_mapping` WRITE;
/*!40000 ALTER TABLE `hotel_partner_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `hotel_partner_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `hotel_type_master` WRITE;
/*!40000 ALTER TABLE `hotel_type_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `hotel_type_master` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `mgmt_news_feed_details` WRITE;
/*!40000 ALTER TABLE `mgmt_news_feed_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `mgmt_news_feed_details` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_asso_document_details`
--

LOCK TABLES `partner_asso_document_details` WRITE;
/*!40000 ALTER TABLE `partner_asso_document_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_asso_document_details` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `partner_duebooking_payments`
--

LOCK TABLES `partner_duebooking_payments` WRITE;
/*!40000 ALTER TABLE `partner_duebooking_payments` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_duebooking_payments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `partner_enquiry_payments`
--

LOCK TABLES `partner_enquiry_payments` WRITE;
/*!40000 ALTER TABLE `partner_enquiry_payments` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_enquiry_payments` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `partner_master` VALUES (18,'abhijit','2013-08-13 00:00:00',2,NULL,858,NULL,NULL,'dan',NULL,NULL,NULL,'2','2013-08-15 00:00:00',NULL,'India');
/*!40000 ALTER TABLE `partner_master` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `partner_master_history`
--

LOCK TABLES `partner_master_history` WRITE;
/*!40000 ALTER TABLE `partner_master_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_master_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `partner_paid_payments`
--

LOCK TABLES `partner_paid_payments` WRITE;
/*!40000 ALTER TABLE `partner_paid_payments` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_paid_payments` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `partner_rating` WRITE;
/*!40000 ALTER TABLE `partner_rating` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_rating` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_service_mapping`
--

LOCK TABLES `partner_service_mapping` WRITE;
/*!40000 ALTER TABLE `partner_service_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_service_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `partner_type` VALUES (1,'client','client'),(2,'service provider','service provider');
/*!40000 ALTER TABLE `partner_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `payee_type_details`
--

LOCK TABLES `payee_type_details` WRITE;
/*!40000 ALTER TABLE `payee_type_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `payee_type_details` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `recommend_type_master`
--

LOCK TABLES `recommend_type_master` WRITE;
/*!40000 ALTER TABLE `recommend_type_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `recommend_type_master` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `room_type_master` WRITE;
/*!40000 ALTER TABLE `room_type_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `room_type_master` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `service_feedback_mapping`
--

LOCK TABLES `service_feedback_mapping` WRITE;
/*!40000 ALTER TABLE `service_feedback_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_feedback_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `state_master` VALUES ('Andhra Pradesh'),('Arunachal Pradesh'),('Assam'),('Bihar'),('Chhattisgarh'),('Goa'),('Gujarat'),('Haryana'),('Himachal Pradesh'),('Jammu and Kashmir'),('Jharkhand'),('Karnataka'),('Kerala'),('Madhya Pradesh'),('Maharashtra'),('Manipur'),('Meghalaya'),('Mizoram'),('Nagaland'),('Orissa'),('Punjab'),('Rajasthan'),('Sikkim'),('Tamil Nadu'),('Tripura'),('Uttar Pradesh'),('Uttarakhand'),('West Bengal');
...
INSERT INTO `status_master` VALUES ('1','active','active'),('2','deactive','deactive');
...
--
-- Dumping data for table `transport_availed_details`
--

LOCK TABLES `transport_availed_details` WRITE;
/*!40000 ALTER TABLE `transport_availed_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `transport_availed_details` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `transport_package_mapping`
--

LOCK TABLES `transport_package_mapping` WRITE;
/*!40000 ALTER TABLE `transport_package_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `transport_package_mapping` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `user_followup_enquiry_master`
--

LOCK TABLES `user_followup_enquiry_master` WRITE;
/*!40000 ALTER TABLE `user_followup_enquiry_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_followup_enquiry_master` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `user_other_info` WRITE;
/*!40000 ALTER TABLE `user_other_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_other_info` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `user_passwd_mgmt` WRITE;
/*!40000 ALTER TABLE `user_passwd_mgmt` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_passwd_mgmt` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `user_service_on_booking_master`
--

LOCK TABLES `user_service_on_booking_master` WRITE;
/*!40000 ALTER TABLE `user_service_on_booking_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_service_on_booking_master` ENABLE KEYS */;
UNLOCK TABLES;
